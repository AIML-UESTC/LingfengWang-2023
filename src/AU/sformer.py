...
from src.AU.heads import AU_former
from src.AU.loss import CCCLoss,AULoss,FocalLoss_Ori
...
class SpatialFormer(nn.Module):
    def __init__(self, modality='V', video_pretrained = True, task='EX'):
        ...
        self.loss_AU = AULoss() #AULoss() #SmoothAULoss()
